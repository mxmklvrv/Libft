...
int	main(void)
{
    ...
    char test4_isalnum[] = {128, 200, 255}; 
    ...
    char test4_isalpha[] = {128, 200, 255}; 
    printf("\nTest Case 4: Extended ASCII characters:\n");
    for (int i = 0; i < 3; i++) {
    ...
    char test1_isascii[] = {0, 32, 48, 65, 97, 127}; 
    ...
    char test2_isascii[] = {128, 200, 255}; 
	...
	char *res_strnstr = ft_strnstr("Hello world", "world", 10);
	char *res_strnstr1 = ft_strnstr("Hello world", "world", 5);
	char *res_strnstr2 = ft_strnstr("abc", "", 3);
	char *res_strnstr3 = ft_strnstr("abc", "", 3);
	char *res_strnstr4 = ft_strnstr("abcdef", "def", 6);
    
	printf("%s\n", res_strnstr ? res_strnstr : "NULL");
	printf("%s\n", res_strnstr1 ? res_strnstr1 : "NULL");
	printf("%s\n", res_strnstr2 ? res_strnstr2 : "NULL");
	printf("%s\n", res_strnstr3 ? res_strnstr3 : "NULL");
	printf("%s\n", res_strnstr4 ? res_strnstr4 : "NULL");
